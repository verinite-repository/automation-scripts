...
public class StepDefinitions extends UIInteractions {
	...
	public void heEntersTheValueDataInTheFieldNamedElementName(String data, String elementName) throws Exception {
		screen.updateByElementName(data, elementName);
	}
	...
	public void heClicksTheButtonNamedButtonName(String buttonName) throws Exception {
		screen.click(buttonName);
	}
