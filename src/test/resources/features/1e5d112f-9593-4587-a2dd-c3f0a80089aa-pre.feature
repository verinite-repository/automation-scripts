...
Scenario Outline: ADACTIN_NEW_USER
    ...
    Then He should be able to view <adatin_register_page> in the field
     Examples:     
          |  user  |  adactin  |  new_User_Register_Here  |  username_name_value  |  username_name_element  |  password_pass_value  |  password_pass_element  |  confirm_Password_value  |  confirm_Password_element  |  full_Name_value  |  full_Name_element  |  adatin_register_page  |  
          |  John Doe  |  https://adactinhotelapp.com/index.php  |  //*[@id='login_form']/table/tbody/tr[7]/td/a  |  VeriniteCardtest  |  username  |  Verinite@123  |  password  |  Verinite@123  |  re_password  |  Verinite technology  |  full_name  |  https://adactinhotelapp.com/Register.php  |  
