...
Scenario Outline: ART_OF_TESTING_CHECKOUT
    ...
    And he clicks the button named <AOT_ADD_TO_CART_BTN>
    ...
    And he should be able to view <AOT_PRODUCT_CHECKOUT_SUCCESS> in the field
     Examples:     
          ...
          |  test  |  https://ecommerce.artoftesting.com/  |  //*[@id='root']/div/div[1]/div/div/div/div[1]/form/button  |  //*[@id='root']/div/div[3]/div/div/select  |  //*[@id='root']/div/div[3]/div/div/select/option[2]  |  //*[@id="root"]/div/div[4]/div/div[1]/div[4]/button  |  Header_cart__Jnfkn  |  //*[@id="root"]/div[4]/div/table/tbody/tr/td[2]  |  //*[@id="root"]/div[5]/button  |  //*[@id="root"]/div[4]/span  |  
