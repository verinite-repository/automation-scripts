...
Scenario Outline: VERIFY_ADDTOCART_ARTOFTESTING
    ...
    Then he should be able to view <artOfTesting_cart> in the field
     Examples:     
          ...
          |  John Doe  |  https://ecommerce.artoftesting.com/  |  //*[@id='root']/div/div[1]/div/div/div/div[1]/form/button  |  //*[@id='root']/div/div[4]/div/div[3]/div[4]/button  |  https://ecommerce.artoftesting.com/cart  |  
          |  John Doe  |  https://ecommerce.artoftesting.com/  |  //*[@id='root']/div/div[1]/div/div/div/div[1]/form/button  |  //*[@id='root']/div/div[4]/div/div[3]/div[4]/button  |  https://ecommerce.artoftesting.com/cart  |  
