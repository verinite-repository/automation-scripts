...
Scenario Outline: VERIFY_SORTING_ARTOFTESTING
    ...
    Then he should be able to view <artOfTesting_Ecom> in the field
     Examples:     
          ...
          |  test  |  https://ecommerce.artoftesting.com/  |  //*[@id='root']/div/div[1]/div/div/div/div[1]/form/button  |  //*[@id='root']/div/div[3]/div/div/select  |  //*[@id='root']/div/div[3]/div/div/select/option[2]  |  Dummy Ecommerce  |  
