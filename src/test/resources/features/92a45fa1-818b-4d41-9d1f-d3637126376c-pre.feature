...
Scenario Outline: VERIFY_THAT_USER_IS_ABLE_TO_CHECK_ALL_FIELDS
    ...
    Then he should be able to view <telerik_kedo_page> in the field
     Examples:     
          ...
          |  testuser123  |  https://www.telerik.com/  |  //*[@id='js-tlrk-nav']/section/div/ul/li/button  |  //*[@id='js-tlrk-nav-dash']/div/div/div[2]/div[1]/div[1]/div[1]/a[1]  |  JavaScript UI Components - Build Better Apps Faster - Progress Kendo UI  |  
