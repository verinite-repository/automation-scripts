...
Scenario Outline: VERIFY_SWAG_LABS_TESTING
    ...
    Then he should be able to view <swag_labs_page> in the field
     Examples:     
          ...
          |  standard_user  |  https://www.saucedemo.com/  |  standard_user  |  user-name  |  secret_sauce  |  password  |  login-button  |  Swag Labs  |  
...
Scenario Outline: VERIFY_THAT_USER_IS_ABLE_TO_ADD_AND_REMOVE_ITEM_INTO_CART
    ...
    Then he should be able to view <swag_labs_page> in the field
     Examples:     
          ...
          |  standard_user  |  https://www.saucedemo.com/  |  standard_user  |  user-name  |  secret_sauce  |  password  |  login-button  |  add-to-cart-sauce-labs-backpack  |  remove-sauce-labs-backpack  |  Swag Labs  |  
