...
Scenario Outline: VERIFY_THAT_USER_IS_ABLE_TO_ADD_AND_REMOVE_ITEM_INTO_CART
    ...
    Then he should be able to view <swag_labs_page> in the field
     Examples:     
          ...
          |  anotheruser456  |  https://www.saucedemo.com/  |  standard_user  |  user-name  |  secret_sauce  |  password  |  login-button  |  add-to-cart-sauce-labs-backpack  |  remove-sauce-labs-backpack  |  Swag Labs  |  
...
Scenario Outline: VERIFY_THAT_USER_IS_ABLE_TO_DO_SORTING
    ...
    And he clicks the button named <add_to_cart>
    And he clicks the button named <remove_cart>
    And he clicks the button named <sort_button>
    Then he should be able to view <swag_labs_page> in the field
     Examples:     
          ...
          |  yetanotheruser789  |  https://www.saucedemo.com/  |  standard_user  |  user-name  |  secret_sauce  |  password  |  login-button  |  add-to-cart-sauce-labs-backpack  |  remove-sauce-labs-backpack  |  header_container  |  Swag Labs  |  
